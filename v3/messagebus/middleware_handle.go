...
type HandleOptions struct {
    /* AllowMissingHandler changes an unhandled message from dispatch failure to warning and pass-through. On consumption this can acknowledge the message; the default refusal preserves retry and dead-letter handling. */
