...
type GenerateReport struct {
    ...
    /* UnusedExcludes lists unmatched exclusion patterns prefixed with package import paths. Strict generation rejects them. */
    UnusedExcludes []string
    /* BindTargetsUnchecked reports binds whose targets cannot be verified because DeclaredParameters is empty. The CLI supplies the running configuration; direct Generate callers must supply it explicitly. */
