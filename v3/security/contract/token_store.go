...
/* RevocableTokenStore supports individual withdrawal. Put stores without expiry; PutWithTtl requires a positive TTL and refuses zero or negative durations. */
