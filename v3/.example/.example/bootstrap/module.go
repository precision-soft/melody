...
import (
    "github.com/precision-soft/melody/v3/.example/domain/entity"
    "github.com/precision-soft/melody/v3/.example/infra/command"
    "github.com/precision-soft/melody/v3/.example/infra/event/subscriber"
    "github.com/precision-soft/melody/v3/.example/infra/http/handler"
    handlercategory "github.com/precision-soft/melody/v3/.example/infra/http/handler/category"
    handlercurrency "github.com/precision-soft/melody/v3/.example/infra/http/handler/currency"
    handlerproduct "github.com/precision-soft/melody/v3/.example/infra/http/handler/product"
    handleruser "github.com/precision-soft/melody/v3/.example/infra/http/handler/user"
    "github.com/precision-soft/melody/v3/.example/infra/http/route"
    "github.com/precision-soft/melody/v3/.example/infra/security"
