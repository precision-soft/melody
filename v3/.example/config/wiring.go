...
func NewWiringBindSet() *melodywiring.BindSet {
    ...
    bindSet.Package(wiringImportPathPrefix+"repository", wiringDirectoryPrefix+"repository")

    bindSet.Package(wiringImportPathPrefix+"service", wiringDirectoryPrefix+"service")

    bindSet.Package(wiringImportPathPrefix+"reporting", wiringDirectoryPrefix+"reporting").
