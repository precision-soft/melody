...
/* ApiRefusal renders JSON-binding and validation refusals. Validation errors expose field-level messages; other refusals keep a generic public message and expose their cause only in debug context. */
func ApiRefusal(
    runtimeInstance melodyruntimecontract.Runtime,
    request melodyhttpcontract.Request,
    statusCode int,
