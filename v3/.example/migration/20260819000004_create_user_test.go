...
func TestUpCreateUserCreatesTheTableTolerantly(t *testing.T) {
    ...
    if false == strings.Contains(queries[0], "CREATE TABLE IF NOT EXISTS `melody_example_v3_user`") {
...
func TestDownCreateUserDropsTheTableTolerantly(t *testing.T) {
    ...
    if false == strings.Contains(queries[0], "DROP TABLE IF EXISTS `melody_example_v3_user`") {
