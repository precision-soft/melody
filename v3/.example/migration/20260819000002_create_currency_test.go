...
func TestUpCreateCurrencyCreatesTheTableTolerantly(t *testing.T) {
    ...
    if false == strings.Contains(queries[0], "CREATE TABLE IF NOT EXISTS `melody_example_v3_currency`") {
...
func TestDownCreateCurrencyDropsTheTableTolerantly(t *testing.T) {
    ...
    if false == strings.Contains(queries[0], "DROP TABLE IF EXISTS `melody_example_v3_currency`") {
