...
func TestUpCreateCatalogJournalCreatesTheTableTolerantly(t *testing.T) {
    ...
    if false == strings.Contains(queries[0], "CREATE TABLE IF NOT EXISTS `melody_example_v3_catalog_journal`") {
...
func TestDownCreateCatalogJournalDropsTheTableTolerantly(t *testing.T) {
    ...
    if false == strings.Contains(queries[0], "DROP TABLE IF EXISTS `melody_example_v3_catalog_journal`") {
