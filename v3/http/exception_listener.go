...
func RegisterKernelExceptionListener(eventDispatcher eventcontract.EventDispatcher, debugMode bool) {
    eventDispatcher.AddListener(
        ...
        func(runtimeInstance runtimecontract.Runtime, eventValue eventcontract.Event) error {
            ...
            /* the validationErrors context key is the public half of an http exception's context: BindJsonAndValidate attaches the per-field validation errors under it, and without this the detail the validator computed reached neither the client nor, structured, anything else.
