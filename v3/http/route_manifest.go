...
/* RouteManifestEntry includes path, methods, host, schemes, locales and priority needed for frontend route generation. Requirements retain their declared unanchored patterns; consumers must enforce whole-segment matching and account for differences from Go’s regular-expression syntax. */
