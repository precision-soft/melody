...
import (
    ...
    "github.com/precision-soft/melody/v3/http/cors"
)

/* Deprecated: use github.com/precision-soft/melody/v3/http/cors.Service instead. */
...
/* Deprecated: use github.com/precision-soft/melody/v3/http/cors.NewService instead. */
func NewCorsConfig(
    allowOrigins []string,
    allowMethods []string,
    allowHeaders []string,
...
/* Deprecated: use github.com/precision-soft/melody/v3/http/cors.DefaultService instead. */
...
/* Deprecated: use github.com/precision-soft/melody/v3/http/cors.RestrictiveService instead. */
...
func CorsMiddleware(config *CorsConfig) httpcontract.Middleware {
    /* nil reads as the default service, as the replacement door reads it */
    if nil == config {
...
/* Deprecated: use github.com/precision-soft/melody/v3/http/cors.DefaultMiddleware instead. */
func DefaultCorsMiddleware() httpcontract.Middleware {
    return cors.DefaultMiddleware()
}

/* Deprecated: use github.com/precision-soft/melody/v3/http/cors.Restrictive instead. */
