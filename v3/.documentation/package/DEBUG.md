...
The build sweep carries each registration’s lifetime. A scoped row never displays the teardown node of a container registration sharing its name, including windowed and single-service views.
