...
- security: validate every public regex alternative against the parsed start anchor; `^/public|/status` is refused, while anchored flag and grouped forms are accepted.
