...
func RedactQueryValuesForDiagnostics(rawQuery string) string {
    ...
    for _, pair := range pairs {
        ...
        /* an empty segment, the trailing "&" of a hand-built url or a doubled "&", carries nothing to redact or diagnose and stays empty rather than reading as a withheld value */
        if "" == pair {
