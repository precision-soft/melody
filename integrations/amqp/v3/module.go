...
/* ModuleConfig registers pre-built AMQP objects. The container closes only resolved services; the composition root owns unresolved objects and must declare dependencies between captured resources. Register the hub that owns a ServerSentEventBackplane, or close that hub explicitly. */
