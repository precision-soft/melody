...
func (instance *fixedDatabaseProvider) Open(resolver containercontract.Resolver) (*bun.DB, error) {
    return instance.database, nil
}
...
func (instance *goexitProvider) Open(resolver containercontract.Resolver) (*bun.DB, error) {
    instance.startOnce.Do(
        func() {
            close(instance.openStarted)
        },
...
func (instance *errorBesideAPanickingCloseProvider) Open(resolver containercontract.Resolver) (*bun.DB, error) {
    instance.startOnce.Do(
        func() {
            close(instance.openStarted)
        },
