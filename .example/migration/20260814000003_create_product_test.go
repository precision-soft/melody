...
func TestUpCreateProductCreatesTheTableTolerantly(t *testing.T) {
    ...
    if false == strings.Contains(queries[0], "CREATE TABLE IF NOT EXISTS `melody_example_v1_product`") {
...
func TestDownCreateProductDropsTheTableTolerantly(t *testing.T) {
    ...
    if false == strings.Contains(queries[0], "DROP TABLE IF EXISTS `melody_example_v1_product`") {
