...
/* CatalogReportService stamps a reading of the catalogue and remembers it for a while; its injected clock lets a test state the exact instant a report, fresh or cached, carries. */
