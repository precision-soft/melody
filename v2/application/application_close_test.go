...
/* the failure the teardown DID discover has to travel out of it, because the exit code of the process is built from it: a shutdown that lost a connection must not exit zero. */
