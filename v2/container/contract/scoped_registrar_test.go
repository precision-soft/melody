...
/* the discrimination between the two lifetimes rests on the two method sets never overlapping. Go interfaces are structural: the moment ScopedRegistrar carries Register — by embedding Registrar, or by anyone spelling the method — a container registrar satisfies it and a scoped registrar satisfies a Registrar parameter, both without a conversion and both silently. */
