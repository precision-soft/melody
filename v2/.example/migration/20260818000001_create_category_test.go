...
func TestUpCreateCategoryCreatesTheTableTolerantly(t *testing.T) {
    ...
    if false == strings.Contains(queries[0], "CREATE TABLE IF NOT EXISTS `melody_example_v2_category`") {
...
func TestDownCreateCategoryDropsTheTableTolerantly(t *testing.T) {
    ...
    if false == strings.Contains(queries[0], "DROP TABLE IF EXISTS `melody_example_v2_category`") {
