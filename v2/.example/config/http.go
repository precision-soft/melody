...
import (
    "github.com/precision-soft/melody/v2/.example/handler"
    handlercategory "github.com/precision-soft/melody/v2/.example/handler/category"
    handlercurrency "github.com/precision-soft/melody/v2/.example/handler/currency"
    handlerproduct "github.com/precision-soft/melody/v2/.example/handler/product"
    handleruser "github.com/precision-soft/melody/v2/.example/handler/user"
