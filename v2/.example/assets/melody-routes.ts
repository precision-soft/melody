/*
 * melody-routes — generate URLs on the frontend from the route manifest the example
 * assembles in url.RoutesJsonFromContainer and page.go injects into every page as
 * window.melodyRoutes, referencing routes by name instead of hardcoding paths.
 *
