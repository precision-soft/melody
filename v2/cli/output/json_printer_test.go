...
/* a sink that accepts fewer bytes than it is handed, with no error, reaches the json door through the one write of the whole document, and a truncated document is what a machine consumer cannot parse */
